        ...
        <Card className="border-border/40 shadow-sm">
            ...
            <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="fullName" placeholder="Muhammad Ahmed" className="pl-10" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <User className="absolute left-3 top-3 w-4 h-4 text-muted-foreground" />
                            <Input id="fatherName" placeholder="Aslam Khan" className="pl-10" />
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="cnic" placeholder="42201-XXXXXXX-X" className="pl-10" />
                        </div>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input id="phone" placeholder="03001234567" className="pl-10" disabled value="03001234567" />
                        </div>
                    </div>
                    <div className="space-y-2">
                ...
                <div className="flex justify-end gap-3 pt-4 border-t border-border/40">
                    ...
                    <Button className="gradient-primary text-white px-8">Save & Continue</Button>
                </div>
            </CardContent>
        </Card>
    );
