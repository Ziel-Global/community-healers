...
export function ExamStep({ onNext }: WizardStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sticky top-0 z-20 bg-background/95 backdrop-blur-md p-4 rounded-2xl border border-border/40 shadow-sm flex items-center justify-between gap-6">
      ...
      <div className="grid lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-4">
          <Card className="border-border/40 shadow-sm sticky top-32">
