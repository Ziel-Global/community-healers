...
export function ApplicationCard({ application, cityName, inspectorName }: ApplicationCardProps) {
                ...
                <div className="flex items-center justify-between pt-1.5 border-t border-border/30">
                    {inspectorName ? (
                        <div className="flex items-center gap-1.5 min-w-0">
                            ...
                            <span className="text-[11px] text-muted-foreground truncate">{inspectorName}</span>
                        </div>
                    ) : (
