...
export function KanbanColumn({ status, applications, cityNameById, inspectorNameById }: KanbanColumnProps) {
                ...
                {applications.length === 0 ? (
                    ...
                    applications.map((application) => (
                        <ApplicationCard
                            ...
                            inspectorName={application.inspectorId ? inspectorNameById.get(application.inspectorId) ?? null : null}
                        />
                    ))
                )}
            </div>
