...
import { centerApplicationService } from "@/services/centerApplicationService";
...
export function EvidenceThumbnail({ evidenceId }: { evidenceId: string }) {
    ...
    useEffect(() => {
        ...
        centerApplicationService.getEvidenceBlob(evidenceId)
            .then((blob) => {
                if (cancelled) return;
