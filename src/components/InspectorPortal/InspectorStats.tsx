...
import type { InspectorApplication } from "@/services/inspectorService";
...
export function InspectorStats({ applications }: { applications: InspectorApplication[] }) {
    const total = applications.length;
    const active = applications.filter((a) => a.status === "INSPECTION_IN_PROGRESS").length;
