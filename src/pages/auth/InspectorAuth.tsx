...
export default function InspectorAuth() {
  ...
  const { loginInspector, logout, isAuthenticated } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await loginInspector(result.data);
      navigate("/inspector");
    ...
    <div className="fixed inset-0 bg-white flex overflow-hidden">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden" style={{ backgroundColor: '#13452c' }}>
        <div className="relative z-10 flex flex-col justify-center px-12">
          ...
          <h1 className="text-4xl alumni-sans-title mb-4 text-white">Inspector</h1>
          <p className="text-lg text-white/90 leading-relaxed max-w-md">
            Review assigned center applications and record physical inspection results.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col px-6 lg:px-16 bg-white">
        <div className="sticky top-0 z-10 bg-white pt-4 pb-2 flex items-center justify-between lg:justify-end">
          <div className="lg:hidden flex items-center gap-2">
            ...
            <span className="text-sm font-display font-bold">Inspector</span>
          </div>
        ...
        <div className="max-w-md mx-auto w-full flex-1 flex flex-col justify-center py-6 sm:py-12">
          ...
          <p className="text-muted-foreground mb-8">Access your assigned inspections</p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="inspector@ziel.com"
          ...
          <div className="mt-8 p-4 rounded-lg bg-primary/10 border border-primary/20">
            <p className="text-xs text-muted-foreground text-center">
              Inspector accounts are created by the Super Admin.
            </p>
          </div>
        </div>
      </div>
